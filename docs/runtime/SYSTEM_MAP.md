...
| 17.4A | Shared Store Cutover | ENGINEERING + AUTOMATED DEBUG 10 / 10 PASS / STANDARD-BROWSER BASELINE CUTOVER + FRESH BASELINE QUALITY INITIALIZATION + CONTROLLED DUAL-CLIENT HUMAN CHECK PASS / INDEPENDENT BROWSER-KERNEL CONFIRMATION PENDING | [Phase 17.4](../education/phase/phase17_4.md) |
