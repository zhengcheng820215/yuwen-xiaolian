...
export const questionMetadataPatterns: QuestionMetadataPattern[] = [
  ...
  },
  {
    ...
    matchers: [/人物形象|形象/, /怎样的人|什么样的人/, /人物.*特点|特点/, /评价.*(父亲|母亲|人物|他|她)/, /塑造.*(父亲|母亲|人物|他|她)/],
  ...
  },
  {
    ...
    antiMatchers: [/概括|含义|表达效果|作用|人物形象/, /写一段|写几句|表达.*看法|联系生活|谈谈|仿写/],
    priority: 70,
    confidence: 0.8,
  },
  {
    ...
    examples: ['请仿写一句话。', '联系生活谈谈你的感受。', '请写一段话表达你的看法。'],
    matchers: [/仿写|改写|扩写|续写/, /写一段|写几句|表达你的看法/, /联系生活|谈谈感受|谈感受|启示/, /你的理解和体会/],
    priority: 76,
    confidence: 0.78,
  },
  {
